...
Среднеквадратичное отклонение:
\[
\sigma \approx \sqrt{\frac{\sum (R_i - R_{\text{cp}})^{2}}{n-1}} = 0~\text{Ом}
\]
\( \sigma_{\bar{x}} \approx \dfrac{\sigma}{\sqrt{50}} = 0~\text{Ом} \)
\\
Погрешность прибора > > предела погрешности.
\\Следовательно погрешность измерений равна инструментальной погрешности - пределу допускаемой погрешности прибора.
\\
...
\]
\[
R = 3{,}9698 \pm 0.1694~\text{Ом}
\]
Предел погрешности  \(\sigma\) < < предела допускаемой погрешности прибора  \(\omega\).
...
\]
Округляем, получаем диапазон от 3.90 до 4.11 Ом. Разобьем диапазон (0.21~Ом) на 5 интервалов по 0,042~Ом.
...
\hline
1 & 3.900 – 3.942 & 13 & 0.26 \\
2 & 3.942 – 3.984 & 16 & 0.32 \\
3 & 3.984 – 4.026 & 16 & 0.32 \\ 
4 & 4.026 – 4.068 & 4 & 0.08 \\
5 & 4.068 – 4.110 & 1 & 0.02 \\
...
\[
\sigma \approx |R_{\text{пик}} - R_{\text{перегиба}}| \approx |3.98-4.02|~\text{Ом} 
\]
